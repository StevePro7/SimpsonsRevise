M:test_manager
F:G$engine_test_manager_init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_riff_manager_play$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltest_manager.engine_riff_manager_play$index$1$21({1}SC:U),B,1,4
S:Ltest_manager.engine_riff_manager_play$data$1$22({2}DG,SC:U),R,0,0,[c,b]
S:Ltest_manager.engine_riff_manager_play$bank$1$22({1}SC:U),R,0,0,[d]
