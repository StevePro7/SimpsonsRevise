...
S:Lactor_manager.engine_actor_manager_draw$index$1$21({1}SC:U),R,0,0,[]
S:Lactor_manager.engine_actor_manager_draw$tileset$1$21({2}DG,SC:U),R,0,0,[e,d]
S:Lactor_manager.engine_actor_manager_draw$tilemap$1$21({2}DG,SC:U),R,0,0,[c,b]
S:Lactor_manager.engine_actor_manager_draw$palette$1$21({2}DG,SC:U),B,1,-2
S:Lactor_manager.engine_actor_manager_draw$banking$1$21({1}SC:U),R,0,0,[h]
