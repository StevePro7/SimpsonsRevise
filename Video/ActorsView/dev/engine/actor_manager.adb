M:actor_manager
F:G$engine_actor_manager_draw$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lactor_manager.engine_actor_manager_draw$index$1$18({1}SC:U),R,0,0,[]
S:Lactor_manager.engine_actor_manager_draw$tileset$1$18({2}DG,SC:U),R,0,0,[e,d]
S:Lactor_manager.engine_actor_manager_draw$tilemap$1$18({2}DG,SC:U),R,0,0,[c,b]
S:Lactor_manager.engine_actor_manager_draw$palette$1$18({2}DG,SC:U),B,1,-2
S:Lactor_manager.engine_actor_manager_draw$banking$1$18({1}SC:U),R,0,0,[h]
S:G$actor_tileset$0$0({0}DA0d,DG,SC:U),E,0,0
S:G$actor_tilemap$0$0({0}DA0d,DG,SC:U),E,0,0
S:G$actor_palette$0$0({0}DA0d,DG,SC:U),E,0,0
S:G$actor_banking$0$0({0}DA0d,SC:U),E,0,0
