...
S:Lquiz_manager.engine_quiz_manager_bank$b$1$30({1}SC:U),B,1,4
F:G$engine_quiz_manager_load$0$0({2}DF,SV:S),Z,0,4,0,0,0
S:Lquiz_manager.engine_quiz_manager_load$qi$1$32({1}SC:U),B,1,4
S:Lquiz_manager.engine_quiz_manager_load$qv$1$32({1}SC:U),B,1,5
S:Lquiz_manager.engine_quiz_manager_load$opt1$1$32({1}SC:U),B,1,6
...
S:Lquiz_manager.show_diff$y$1$38({1}SC:U),B,1,5
