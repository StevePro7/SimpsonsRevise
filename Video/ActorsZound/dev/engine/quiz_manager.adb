...
S:Lquiz_manager.engine_quiz_manager_bank$b$1$25({1}SC:U),B,1,4
F:Fquiz_manager$show_diff$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lquiz_manager.show_diff$x$1$27({1}SC:U),B,1,4
S:Lquiz_manager.show_diff$y$1$27({1}SC:U),B,1,5
