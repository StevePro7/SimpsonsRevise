...
F:G$engine_audio_manager_start_music$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_finish_music$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_stop_music$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_right$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_wrong$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_cheat$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_woohoo$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_doh$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Faudio_manager$play_music$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.play_music$music$1_0$74({2}DG,SC:U),B,1,4
S:Laudio_manager.play_music$bank$1_0$74({1}SC:U),B,1,6
F:Faudio_manager$play_sound$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.play_sound$sfx$1_0$77({2}DG,SC:U),B,1,4
...
S:Faudio_manager$prevRight$0_0$0({1}SC:U),E,0,0
S:Faudio_manager$currRight$0_0$0({1}SC:U),E,0,0
S:Faudio_manager$prevWrong$0_0$0({1}SC:U),E,0,0
S:Faudio_manager$currWrong$0_0$0({1}SC:U),E,0,0
