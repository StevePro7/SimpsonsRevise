...
S:Lselect_manager.engine_select_manager_load_long$idx$1$31({1}SC:U),R,0,0,[c]
F:G$engine_select_manager_load_quiz$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_select_manager_move_up$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lselect_manager.engine_select_manager_move_up$select_choice$1$35({1}SC:U),B,1,4
F:G$engine_select_manager_move_down$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lselect_manager.engine_select_manager_move_down$select_choice$1$39({1}SC:U),B,1,4
