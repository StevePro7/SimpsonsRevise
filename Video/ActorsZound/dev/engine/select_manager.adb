...
S:Lselect_manager.engine_select_manager_clear$high$1$16({1}SC:U),R,0,0,[b]
...
S:Lselect_manager.engine_select_manager_clear3$idx$1$28({1}SC:U),R,0,0,[c]
F:G$engine_select_manager_load_diff$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lselect_manager.engine_select_manager_load_diff$idx$1$31({1}SC:U),R,0,0,[c]
F:G$engine_select_manager_load_long$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lselect_manager.engine_select_manager_load_long$idx$1$34({1}SC:U),R,0,0,[b]
F:G$engine_select_manager_load_quiz$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_select_manager_move_up$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lselect_manager.engine_select_manager_move_up$select_choice$1$38({1}SC:U),B,1,4
F:G$engine_select_manager_move_down$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lselect_manager.engine_select_manager_move_down$select_choice$1$42({1}SC:U),B,1,4
