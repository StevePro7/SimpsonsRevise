M:splash_screen
F:G$screen_splash_screen_init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_splash_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_splash_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsplash_screen.screen_splash_screen_update$screen_type$1_0$27({2}DG,SC:U),B,1,4
S:Lsplash_screen.screen_splash_screen_update$input$1_0$28({1}SC:U),R,0,0,[a]
S:Lsplash_screen.screen_splash_screen_update$level$1_0$28({1}SC:U),R,0,0,[c]
...
S:Fsplash_screen$screen_splash_screen_delay$0_0$0({1}SC:U),E,0,0
