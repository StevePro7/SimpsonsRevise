...
S:Lfunc_screen.screen_func_screen_update$input$1_0$28({1}SC:U),R,0,0,[a]
F:Ffunc_screen$draw_screen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.draw_screen$index$1_0$36({1}SC:U),B,1,4
