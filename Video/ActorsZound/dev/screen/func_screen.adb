...
S:Lfunc_screen.screen_func_screen_update$screen_type$1$26({2}DG,SC:U),B,1,4
S:Lfunc_screen.screen_func_screen_update$input$1$27({1}SC:U),R,0,0,[l]
F:Ffunc_screen$draw_screen$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.draw_screen$index$1$35({1}SC:U),B,1,4
