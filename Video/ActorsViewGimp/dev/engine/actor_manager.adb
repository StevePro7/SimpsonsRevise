...
S:Lactor_manager.engine_actor_manager_draw_tests$index$1$20({1}SC:U),R,0,0,[]
S:Lactor_manager.engine_actor_manager_draw_tests$tileset$1$20({2}DG,SC:U),R,0,0,[e,d]
S:Lactor_manager.engine_actor_manager_draw_tests$tilemap$1$20({2}DG,SC:U),R,0,0,[c,b]
S:Lactor_manager.engine_actor_manager_draw_tests$palette$1$20({2}DG,SC:U),R,0,0,[l,h]
S:Lactor_manager.engine_actor_manager_draw_tests$banking$1$20({1}SC:U),R,0,0,[]
F:G$engine_actor_manager_draw_actor$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lactor_manager.engine_actor_manager_draw_actor$index$1$21({1}SC:U),B,1,4
S:Lactor_manager.engine_actor_manager_draw_actor$tileset$1$22({2}DG,SC:U),R,0,0,[e,d]
S:Lactor_manager.engine_actor_manager_draw_actor$tilemap$1$22({2}DG,SC:U),B,1,-2
S:Lactor_manager.engine_actor_manager_draw_actor$palette$1$22({2}DG,SC:U),R,0,0,[c,b]
S:Lactor_manager.engine_actor_manager_draw_actor$banking$1$22({1}SC:U),R,0,0,[]
