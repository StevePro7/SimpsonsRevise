M:actor_manager
F:Factor_manager$foo$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lactor_manager.foo$n$1$21({1}SC:U),B,1,4
S:Lactor_manager.foo$tileset$1$21({2}DG,SV:S),B,1,5
S:Lactor_manager.foo$tilemap$1$21({2}DG,SC:U),B,1,7
S:Lactor_manager.foo$palette$1$21({2}DG,SV:S),B,1,9
F:G$engine_actor_manager_init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_actor_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lactor_manager.engine_actor_manager_draw$felt$1$24({1}SC:U),B,1,4
F:G$engine_actor_manager_draw_tests$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lactor_manager.engine_actor_manager_draw_tests$index$1$26({1}SC:U),R,0,0,[]
S:Lactor_manager.engine_actor_manager_draw_tests$tileset$1$26({2}DG,SC:U),R,0,0,[e,d]
S:Lactor_manager.engine_actor_manager_draw_tests$tilemap$1$26({2}DG,SC:U),R,0,0,[c,b]
S:Lactor_manager.engine_actor_manager_draw_tests$palette$1$26({2}DG,SC:U),R,0,0,[l,h]
S:Lactor_manager.engine_actor_manager_draw_tests$banking$1$26({1}SC:U),R,0,0,[]
F:G$engine_actor_manager_draw_tests00$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_actor_manager_draw_tests01$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_actor_manager_draw_actor$0$0({2}DF,SV:S),Z,0,2,0,0,0
...
S:Factor_manager$draw_method$0$0({4}DA2d,DC,DF,SV:S),E,0,0
...
S:Factor_manager$foo$0$0({2}DF,SV:S),C,0,0
