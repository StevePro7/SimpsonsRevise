...
S:Lactor_manager.engine_actor_manager_draw$index$1$22({1}SC:U),B,1,4
F:Factor_manager$draw_impl$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lactor_manager.draw_impl$n$1$24({1}SC:U),B,1,4
S:Lactor_manager.draw_impl$tileset$1$24({2}DG,SC:U),B,1,5
S:Lactor_manager.draw_impl$tilemap$1$24({2}DG,SC:U),B,1,7
S:Lactor_manager.draw_impl$palette$1$24({2}DG,SC:U),B,1,9
