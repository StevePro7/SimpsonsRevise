...
void screen_ready_screen_load()
{
	...
	engine_font_manager_text( LOCALE_ARROW_LEFT, 2, 7 );
	engine_font_manager_text( select_diff_option[ diff_select ], 3, 7 );

	engine_font_manager_text( LOCALE_QUESTIONS, 3, 12 );
	engine_font_manager_text( LOCALE_ARROW_LEFT, 2, 13 );
	engine_font_manager_data( question_long, 5, 13 );

	engine_font_manager_text( LOCALE_GET, 3, 18 );
	engine_font_manager_text( LOCALE_READY, 3, 19 );
...
void screen_ready_screen_update( unsigned char *screen_type )
{
	...
	{
		// Clean up.
		engine_font_manager_text( LOCALE_BLANK5, 2, 7 );
		engine_font_manager_text( LOCALE_BLANK11, 2, 11 );
		engine_font_manager_text( LOCALE_BLANK5, 2, 12 );
		engine_font_manager_text( LOCALE_BLANK8, 3, 18 );
